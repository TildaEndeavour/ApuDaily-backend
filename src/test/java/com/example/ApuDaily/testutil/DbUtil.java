...
public class DbUtil implements Util {
  ...
  public Category createCategory(int seed) {
    return categoryRepository.save(
        Category.builder().name("Category " + seed).slug("category " + seed).build());
  }

  @Override
  public Tag createTag(int seed) {
    return tagRepository.save(Tag.builder().name("Tag " + seed).build());
  }
  ...
  public TargetType createPostTargetType() {
    return targetTypeRepository.save(TargetType.builder().name("POST").build());
  }
